...
* Intermediate R 
  + Lots of good basics, but I think everybody took this 
* Writing Functions in R 
  + Going over more in depth how functions work and when to use functions 
* Writing Efficient R Code 
  + Builds upon the previous 2 courses 
...
* Parallel Programming 
  ...
  + Can't be used on everything, but still super useful for functions that run without dependence on previous outcomes
